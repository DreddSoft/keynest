...
function UnitDashboard() {
    ...
    // Retornamos el html
    return (
        <div className="h-screen bg-gray-100 rounded-2xl p-6">
            <header className="flex flex-row justify-between h-1/4 items-center border rounded-2xl">
                <div className="ml-4 ">
                    <img
                        className="w-32"
            ...
            <section className="flex flex-row justify-between items-center h-3/4 border rounded-2xl">
